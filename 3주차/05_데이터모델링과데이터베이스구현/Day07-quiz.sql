...
/* ----------------------------------------------------------------
   ...
   ---------------------------------------------------------------- */
SELECT c.country, sum(od.quantityOrdered * od.priceEach)
from customers c
...
/* ----------------------------------------------------------------
   ...
   ---------------------------------------------------------------- */
SELECT p.productLine, (od.quantityOrdered * od.priceEach) as total_revenue, od.quantityOrdered as total_qty
from products p
